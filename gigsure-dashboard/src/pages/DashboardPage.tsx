    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-6 space-y-6 pb-20">
        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <motion.div 
              ...
              className="col-span-2 sm:col-span-2 p-4 rounded-lg bg-card/50 backdrop-blur-sm border border-border/50"
            >
              <p className="text-xs text-muted-foreground uppercase tracking-wider mb-3">Risk Score</p>
          ...
          <div className={`rounded-xl p-5 border ${isSubscribed ? 'bg-success/5 border-success/20' : 'bg-warning/5 border-warning/20'}`}>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  {isSubscribed ? 'You are protected against weather disruptions' : 'Subscribe to enable automatic payouts'}
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            {isSubscribed ? 'Manage' : 'Subscribe to'} Insurance
          </button>
          <button
