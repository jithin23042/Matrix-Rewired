    ...
    <div className="min-h-screen bg-background pb-6">
      ...
      <div className="container py-6 max-w-2xl space-y-6">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-red-500/20 to-red-600/5 border border-red-200 rounded-xl p-6 text-center"
        >
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ delay: 0.1, type: "spring" }}
            className="h-12 w-12 mx-auto mb-3 rounded-full bg-red-500/10 flex items-center justify-center"
          >
              ...
              {videoPreview ? (
                ...
                <div className="border-2 border-dashed border-border rounded-lg p-8 text-center hover:border-red-500/50 transition-colors">
                  ...
                  <label
                    ...
                    className="inline-block px-4 py-2 bg-red-500 text-white font-medium rounded-lg cursor-pointer hover:brightness-110 transition-all"
                  >
                    Select Video
                  </label>
                </div>
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  {
                    key: "curfewProof",
                    label: "Curfew notice clearly visible",
                    hint: "Show official notice or news",
                  },
                  {
                    key: "locationProof",
                    label: "Location details visible",
                    hint: "Show area/zone affected by curfew",
                  },
                  {
                    key: "timelineProof",
                    label: "Curfew timeline shown",
                    hint: "Display start and end time",
                  },
                ].map((item) => (
                  <motion.label
                    key={item.key}
...
export default CurfewClaimPage;
