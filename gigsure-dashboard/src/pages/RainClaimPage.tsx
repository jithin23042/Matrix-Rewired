...
const RainClaimPage = () => {
  ...
  const allVerified =
    verification.timestampProof &&
    verification.locationProof &&
    verification.visibleDisruption &&
    videoFile;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payoutResult = await payoutAPI.create({
        workerId,
        reason: "Heavy Rain - Video Verified",
        hoursLost: 3,
    ...
    <div className="min-h-screen bg-background pb-6">
      ...
      <div className="container py-6 max-w-2xl space-y-6">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-blue-500/20 to-blue-600/5 border border-blue-200 rounded-xl p-6 text-center"
        >
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ delay: 0.1, type: "spring" }}
            className="h-12 w-12 mx-auto mb-3 rounded-full bg-blue-500/10 flex items-center justify-center"
          >
              ...
              {videoPreview ? (
                ...
                <div className="border-2 border-dashed border-border rounded-lg p-8 text-center hover:border-primary/50 transition-colors">
                  ...
                  <label
                    ...
                    className="inline-block px-4 py-2 bg-primary text-primary-foreground font-medium rounded-lg cursor-pointer hover:brightness-110 transition-all"
                  >
                    Select Video
                  </label>
                </div>
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  {
                    key: "timestampProof",
                    label: "Video shows current timestamp",
                    hint: "Ensure date/time is visible",
                  },
                  {
                    key: "locationProof",
                    label: "Location details are visible",
                    hint: "Show street/building reference",
                  },
                  {
                    key: "visibleDisruption",
                    label: "Heavy rain is clearly visible",
                    hint: "Rain intensity and duration evident",
                  },
                ].map((item) => (
                  <motion.label
                    key={item.key}
