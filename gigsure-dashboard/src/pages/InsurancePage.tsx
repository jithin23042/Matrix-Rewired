...
import { Shield, CloudRain, MapPin, Clock, ArrowLeft, Check } from "lucide-react";
...
const InsurancePage = () => {
  ...
  const handleSubscribe = async () => {
    ...
    try {
      const workerId = localStorage.getItem("workerId");
      const result = await insuranceAPI.subscribe(workerId!);
      ...
      <div className="container py-6 max-w-2xl space-y-6">
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mt-4">Based on ₹{worker.avgHourlyIncome}/hr × ~60 hours/week</p>
          </motion.div>
